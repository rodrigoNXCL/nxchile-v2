    ...
    <section className="relative overflow-hidden bg-[var(--bg)] pt-28 pb-20 sm:pt-40 sm:pb-32">
      <div className="container-premium relative z-10 text-center">
        ...
        <p className="text-lg sm:text-xl text-[#475569] leading-relaxed max-w-3xl mx-auto mb-12 font-medium">
          Digitalizamos procesos, centralizamos información y eliminamos el caos manual para empresas que buscan eficiencia real desde el día uno.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          ...
          <Link href="/experiencia" className="btn-secondary w-full sm:w-auto px-8 py-4 text-lg rounded-full bg-white border border-gray-200">
            Ver cómo trabajamos
          </Link>
        </div>
